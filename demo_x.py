...
if __name__ == '__main__':
    ...
    for ii in range(1):
        ...
        message = "Reference voice: enter an audio filepath of a voice to be cloned (mp3, " \
                    "wav, m4a, flac, ...):\n"
        in_fpath = Path("D:\\Document\\RealTimeVoiceCloning\\President_Donald_Trump_Press_Conference_mp3 00_00_00-00_05_00.wav".replace("\"", "").replace("\'", ""))
